...
class Mapping:
    ...
    def run_cca(object1, object2, standardize=True, num_cc=30, option=1, random_state=0):
        ...
        cca_data = pd.DataFrame(cca_data, index=list(object1.columns) + list(object2.columns), # instead of list(cells1) + list(cells2)
    ...
    def map_codex_to_cite(self,
        ...
        if num_chunks == 1:
            ...
            codex_subset_filtered = codex_subset_filtered.loc[:, common_protein_filtered]
            cite_subset_filtered = cite_subset_filtered.loc[:, common_protein_filtered]
    ...
    def transfer_matrix(self,
        ...
        # Re-arrange columns here....causes kNN to fail if mismatched
        from_dataset = from_dataset[to_dataset.columns]
